checkKeyExists = () => {
    ...
    if (sessionStorage.getItem('id_clasificacion') !== null) {
        let id_clasificacion = sessionStorage.getItem('id_clasificacion');
        document.getElementById('id_clasificacion').value = id_clasificacion;
        sessionStorage.removeItem('id_clasificacion');
...
let id_clasificacion = document.getElementById('id_clasificacion').value;
...
productoDestacado = (pagina) => {
    ...
    request.open('POST', '../clasificacion/modelo/recuperaDestacado.php', false);
    request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    request.send('id_clasificacion=' + id_clasificacion + '&pagina=' + pagina);
};
...
productoVendido = (pagina) => {
    ...
    request.open('POST', '../clasificacion/modelo/recuperaVendido.php', false);
    request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    request.send('id_clasificacion=' + id_clasificacion + '&pagina=' + pagina);
};
